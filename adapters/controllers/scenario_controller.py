...
def handle_scenario(scenario_type: str, scenario_name: str, db: Session = Depends(get_db)):
...
def create_new_scenario(payload: ScenarioCreateSchema, db: Session = Depends(get_db)):
