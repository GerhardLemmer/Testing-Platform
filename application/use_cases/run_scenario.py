...
from infrastructure.scenario_repository import get_scenario, get_steps, get_scenario_in_domain
...
def run_scenario_in_domain(db: Session, domain_id: str, scenario_type: str, scenario_name: str, input_data: dict = None):
